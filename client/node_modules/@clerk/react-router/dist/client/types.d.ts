...
import { CreateComponentProps } from 'react-router/route-module';

type ReactRouterComponentProps = CreateComponentProps<any>;
type ClerkState = {
    __type: 'clerkState';
...
export type { ClerkState, ReactRouterClerkProviderProps, ReactRouterComponentProps, WithClerkState };
