...
type SessionVerificationFirstFactor = EmailCodeFactor | PhoneCodeFactor | PasswordFactor;
...
interface IdentificationLinkResource extends ClerkResource {
    id: string;
    type: string;
    toJSON(): IdentificationLinkJSONSnapshot;
}
...
interface SignUpVerificationsResource {
    ...
    toJSON: () => SignUpVerificationsJSONSnapshot;
}
